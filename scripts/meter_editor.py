...
sc1 = []
sc1.append({'id':'V1', 'x':63, 'y':37, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'Vdeg1', 'x':121, 'y':37, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'V2', 'x':63, 'y':53, 'bg':'g', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'Vdeg2', 'x':121, 'y':53, 'bg':'g', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'V3', 'x':63, 'y':69, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'Vdeg3', 'x':121, 'y':69, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'A1', 'x':63, 'y':88, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'Adeg1', 'x':121, 'y':88, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'A2', 'x':63, 'y':104, 'bg':'g', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'Adeg2', 'x':121, 'y':104, 'bg':'g', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'A3', 'x':63, 'y':120, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'Adeg3', 'x':121, 'y':120, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'freq', 'alias':'f', 'x':83, 'y':155, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'V_unb', 'alias':'V%', 'x':81, 'y':190, 'bg':'g', 'scale': 0.85, 'w_clear': 45})
sc1.append({'id':'A_unb', 'alias':'A%', 'x':82, 'y':206, 'bg':'w', 'scale': 0.85, 'w_clear': 45})
